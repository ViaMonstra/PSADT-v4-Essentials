...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action Install -Path 'WinSCP-6.5.3.msi'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Action Uninstall -Path 'WinSCP-6.5.3.msi'
    ...
    ElseIf ($deploymentType -ieq 'Repair') {
        ...
        Execute-MSI -Action Repair -Path 'WinSCP-6.5.3.msi' -RepairFromSource $true
